...
class Author(models.Model):
    """
        ...
        Attributes:
        -----------
        param name: Describes name of the templates
        type name: str max_length=20
        param surname: Describes last name of the templates
        type surname: str max_length=20
        param patronymic: Describes middle name of the templates
    ...
    def __str__(self):
        ...
        :return: templates id, templates name, templates surname, templates patronymic
        """
    ...
    def get_by_id(author_id):
        ...
        :return: templates object or None if a user with such ID does not exist
        """
        try:
    ...
    def delete_by_id(author_id):
        """
        :param author_id: an id of a templates to be deleted
        :type author_id: int
    ...
    def create(name, surname, patronymic):
        ...
        param name: Describes name of the templates
        type name: str max_length=20
        param surname: Describes surname of the templates
        type surname: str max_length=20
        param patronymic: Describes patronymic of the templates
        type patronymic: str max_length=20
        :return: a new templates object which is also written into the DB
        """
    ...
    def update(self,
               ...
               patronymic=None):
        """
        Updates templates in the database with the specified parameters.\n
        param name: Describes name of the templates
        type name: str max_length=20
        param surname: Describes surname of the templates
        type surname: str max_length=20
